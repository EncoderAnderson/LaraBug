...
import FatherScreenShow from './FatherScreenShow';
import sendMessenger from '../services/firestorePai';
...
const FatherScreen = () => {
  ...
  return (
    <Animated.View style={{ flex: 1, justifyContent: 'center', flexDirection: 'row' }}>
      ...
      />
      <Image
        source={require("../../assets/LaraFather.png")}
      ...
      <View style={{ position: 'absolute', top: height * 0.028, right: width * 0.21 }}>
        <Image
