...
import MotherScreenShow from './MotherScreenShow';
import sendMessenger from '../services/firestoreMae';
...
const MotherScreen = () => {
  ...
  return (
    <Animated.View style={{ flex: 1, justifyContent: 'center', flexDirection: 'row' }}>
      ...
      />
      <Image
        source={require("../../assets/LaraMother.png")}
      ...
      <View style={{ position: 'absolute', top: height * 0.028, right: width * 0.18 }}>
        <Image
